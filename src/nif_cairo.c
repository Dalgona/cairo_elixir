...
#define ATOMS \
  ...
  ATOM_DECL(svg) \
  ATOM_DECL(os2) \
  ATOM_DECL(win32_printing) \
  ATOM_DECL(quartz_image) \
  ATOM_DECL(script) \
  ATOM_DECL(qt) \
  ATOM_DECL(recording) \
  ATOM_DECL(vg) \
...
{
  BEGIN_ATOM_MATCH(term)
    MATCH_ATOM(image, CAIRO_SURFACE_TYPE_IMAGE)
    MATCH_ATOM(pdf, CAIRO_SURFACE_TYPE_PDF)
    MATCH_ATOM(ps, CAIRO_SURFACE_TYPE_PS)
    MATCH_ATOM(xlib, CAIRO_SURFACE_TYPE_XLIB)
    MATCH_ATOM(xcb, CAIRO_SURFACE_TYPE_XCB)
    MATCH_ATOM(glitz, CAIRO_SURFACE_TYPE_GLITZ)
    MATCH_ATOM(quartz, CAIRO_SURFACE_TYPE_QUARTZ)
    MATCH_ATOM(win32, CAIRO_SURFACE_TYPE_WIN32)
    MATCH_ATOM(beos, CAIRO_SURFACE_TYPE_BEOS)
    MATCH_ATOM(directfb, CAIRO_SURFACE_TYPE_DIRECTFB)
    MATCH_ATOM(svg, CAIRO_SURFACE_TYPE_SVG)
    MATCH_ATOM(os2, CAIRO_SURFACE_TYPE_OS2)
    MATCH_ATOM(win32_printing, CAIRO_SURFACE_TYPE_WIN32_PRINTING)
    MATCH_ATOM(quartz_image, CAIRO_SURFACE_TYPE_QUARTZ_IMAGE)
    MATCH_ATOM(script, CAIRO_SURFACE_TYPE_SCRIPT)
    MATCH_ATOM(qt, CAIRO_SURFACE_TYPE_QT)
    MATCH_ATOM(recording, CAIRO_SURFACE_TYPE_RECORDING)
    MATCH_ATOM(vg, CAIRO_SURFACE_TYPE_VG)
    MATCH_ATOM(gl, CAIRO_SURFACE_TYPE_GL)
    MATCH_ATOM(drm, CAIRO_SURFACE_TYPE_DRM)
    MATCH_ATOM(tee, CAIRO_SURFACE_TYPE_TEE)
    MATCH_ATOM(xml, CAIRO_SURFACE_TYPE_XML)
    MATCH_ATOM(skia, CAIRO_SURFACE_TYPE_SKIA)
    MATCH_ATOM(subsurface, CAIRO_SURFACE_TYPE_SUBSURFACE)
    MATCH_ATOM(cogl, CAIRO_SURFACE_TYPE_COGL)
  END_ATOM_MATCH
}
...
int surface_type_to_atom(ErlNifEnv *env, const cairo_surface_type_t term, cairo_surface_type_t *content)
{
  BEGIN_ATOM_CONVERT(term)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_IMAGE, image)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_PDF, pdf)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_PS, ps)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_XLIB, xlib)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_XCB, xcb)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_GLITZ, glitz)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_QUARTZ, quartz)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_WIN32, win32)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_BEOS, beos)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_DIRECTFB, directfb)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_SVG, svg)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_OS2, os2)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_WIN32_PRINTING, win32_printing)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_QUARTZ_IMAGE, quartz_image)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_SCRIPT, script)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_QT, qt)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_RECORDING, recording)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_VG, vg)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_GL, gl)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_DRM, drm)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_TEE, tee)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_XML, xml)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_SKIA, skia)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_SUBSURFACE, subsurface)
    CONVERT_ATOM(CAIRO_SURFACE_TYPE_COGL, cogl)
  END_ATOM_CONVERT
}
