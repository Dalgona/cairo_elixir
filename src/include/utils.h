...
EXTERN int get_binary(ErlNifEnv *env, const ERL_NIF_TERM &term, std::string &dest);
...
extern template int _getvalue<std::string>(ErlNifEnv *env, const ERL_NIF_TERM &term, std::string &dest);
