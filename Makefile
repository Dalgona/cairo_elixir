...
FILES = src/atoms.cpp src/resource_types.cpp src/utils.cpp src/nif_cairo.cpp src/nif_paths.cpp src/nif_surfaces.cpp src/nif_image_surfaces.cpp src/nif_main.cpp
